        ...
        <Container>
          <div className='flex flex-row justify-center align-middle'>
            <div>
              ...
              <div className='pb-20'/>
              <Link href="/p/nitrogencycle/nh3"><Button className="pr-7 pb-8 pl-7 pt-8 text-lg bg-indigo-600 text-white">
              Nitrogen Fixation
              </Button></Link>
            ...
            <div>
              <Image src="/projects/nitrogencycle/N2.png" alt="Nitrogen Cycle" width={500} height={500}/>
            </div>
          </div>
        </Container>
      </Layout>
