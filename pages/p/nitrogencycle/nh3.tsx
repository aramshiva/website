        ...
        <Container>
          <div className='flex flex-row justify-center align-middle'>
            <div>
              ...
              <p>You are a <strong>NH₃</strong> atom. You have been through the process of nitrogen fixation</p>
            </div>
            <div>
              <Image src="/projects/nitrogencycle/NH3.png" alt="Nitrogen Cycle" width={500} height={500}/>
            </div>
          </div>
        </Container>
      </Layout>
