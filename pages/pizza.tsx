            ...
            <Wrapper>
                <div className="flex items-center justify-center">
                    <div className="mx-auto max-w-md rounded-xl bg-white p-14 text-black shadow-lg">
                        ...
                        <p>
                            Ever wonder? Is this pizza cheaper than this pizza?
                            This tool is a short tool, that will calculate the
                            price of a pizza by square inches.
                        </p>
                        <form onSubmit={handleSubmit} className="py-5">
                            ...
                            <div className="mb-4">
                                <input
                                    ...
                                    onChange={(e) =>
                                        setCalculateCrust(e.target.checked)
                                    }
                                />
                                <label
                                    htmlFor="crust_checkbox"
                                    className="pl-1"
                                >
                        ...
                        {responseData.pricePerSquareInch != null && (
                            <p className="mt-4">
                                ...
                                {responseData.pricePerSquareInch.toFixed(2)}
                            </p>
                        )}
                        {responseData.pricePerSquareInchWithoutCrust !=
                            null && (
                            <p className="mt-4">
                                Price per square inch excluding crust: $
                                {responseData.pricePerSquareInchWithoutCrust.toFixed(
                                    2,
                                )}
                            </p>
                        )}
                        {responseData.percentOfPizzaIsCrust != null && (
                            <p className="mt-4">
                                ...
                                {(
                                    responseData.percentOfPizzaIsCrust * 100
                                ).toFixed(2)}
                                %
                            </p>
                        )}
