        ...
        <Layout>
          ...
          <Container>
            ...
            <div className="font-mono">
              ...
              <br />
              <br />
              <p>To: @Reader &lt;reader@acme.com&gt;</p>
              <p>Subject: Coming Soon</p>
              <p>From: @Aram &lt;not-giving-you-my-email&gt;</p>
              <br />
              <br />
              <p>Dear Reader,</p>
              ...
              <span>
                and you stumbled upon my empty page. Come back later for a
              </span>
              <span className="font-serif font-bold">&nbsp;Great Idea</span>
              <br />
              <br />
              <p>-Sincerely</p>
              ...
              <br />
              <br />
              <span>P.S. You can submit a </span>
              <Link
                href="https://github.com/aramshiva/website/issues"
                className="underline"
              >
                {" "}
                GitHub Issue
              </Link>
              <span> and tag it with `enhancement` to request/give an idea!</span>
            </div>
          </Container>
          <Footer />
        </Layout>
